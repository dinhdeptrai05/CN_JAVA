...
public class RequestManagementPanel extends JPanel implements Refreshable {
    ...
    public RequestManagementPanel(AppServices services, User user) {
    ...
    public void refresh() {
        ...
        List<ChangeRequest> rows = services.requests().findForUser(user).stream()
    ...
    private void createRequest() {
        RequestFormDialog.showDialog(this, services, user).ifPresent(request -> {
            try {
    ...
    private void approveRequest() {
        try {
            ...
            services.requests().approve(request, user);
            refresh();
    ...
    private void rejectRequest() {
        try {
            ...
            services.requests().reject(request, user, reason);
            refresh();
