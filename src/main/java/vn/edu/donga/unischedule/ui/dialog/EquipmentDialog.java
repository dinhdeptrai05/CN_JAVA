...
public class EquipmentDialog extends JDialog {
    ...
    private void save() {
        try {
            result = vn.edu.donga.unischedule.controller.FormController.equipment(editing, codeField.getText(),
                    nameField.getText(), categoryField.getText(), quantityField.getText(),
