...
public class NotificationPanel extends JPanel implements Refreshable {
    ...
    public NotificationPanel(AppControllers controllers, User user, ScreenNavigator navigator) {
    ...
    public void refresh() {
        ...
        List<Notification> rows = controllers.notifications().search(user, keyword, type, read);
